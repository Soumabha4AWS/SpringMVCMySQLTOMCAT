...
public class SpringWebFluxClient {
	...
	@GetMapping("/get/welcomeCourses")
	public String getWelcomeCourses() {
		logger.info("*********** inside getWelcomeCourses ************");		
	...
	public String getAllCourses(Model model) {
		...
		Flux < Course > courseFlux = webClient.get().uri("NodeJSRestApiMySQL/get/all")
	...
	public String addCourse(@ModelAttribute("course") Course course) {
		...
		webClient.post().uri("NodeJSRestApiMySQL/post")
	...
	public String updateCourseById(@ModelAttribute("course") Course course) {		
		...
		webClient.put().uri("NodeJSRestApiMySQL/put/{id}", id)
			.accept(MediaType.APPLICATION_JSON)
			.syncBody(course)
			.retrieve()
			.bodyToMono(Course.class)
	...
	public String removeCourseById(@ModelAttribute("course") Course course) {
		...
		webClient.delete().uri("NodeJSRestApiMySQL/delete/{id}", id)
			.accept(MediaType.APPLICATION_JSON)
			.retrieve()
			.bodyToMono(Course.class)
			.log("remove empById :: ");
